...
public class HandlingPaginations {
    ...
    public static void main(String[] args) {
        ...
        boolean flag = true;
        while (flag) {
            //Every time we move to the next page and the next page is reloaded. we have to relocate the element.
            //reinitialize all the elements because the page gets refreshed next click
